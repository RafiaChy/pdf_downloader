...
import 'package:pdf_downloader/common/widgets/loading_widget.dart';
...
class _HomeViewState extends State<HomeView> {
  ...
  builder: (context, state) {
    if(state is HomeDownloading){
      return LoadingWidget(child: buildHomeBody(height, state));
    }
    return buildHomeBody(height, state);
  },
),
),
);
  }
Scaffold buildHomeBody(double height, HomeState state) {
    return Scaffold(
    appBar: AppBar(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                buildDownloadButton(height, state)
              ],
            ),
          )
        ],
  ...
  Container buildDownloadButton(double height, HomeState state) {
    return Container(
